  ...
  <div>
    <div class="alpha">
      ...
      <div class="section-alpha">
        ...
        <div class="section-1">
          <img src="@/assets/afr-sup.webp" alt=""  class="image"/>
        </div>
        <div class="section-2">

          <div id="contact-form" class="contact-form">
            <h1 class="contact-form_title">Need help? Get in touch!</h1>
            <p class="contact-form_paragraph">Whether you have a question about our platforms, or need help with your
              account, our friendly, multi-lingual support team is available 24/7 via live chat and email.</p>
