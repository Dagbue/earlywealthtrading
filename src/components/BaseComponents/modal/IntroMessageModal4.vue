    ...
    <dialog open>
      ...
      <div class="welcome-modal">
        ...
        <form @submit.prevent="updateDetails">
          <p class="text-1">Enter your Trade ID</p>
...
<!--            <label>Trade ID</label>-->
            <input type="text" v-model="firstName2" required="required" placeholder="Enter Trade Id" class="form-input"/>
...
export default {
  ...
  methods: {
    ...
    async updateDetails() {
      ...
      if (this.firstName2 === "TID-Stock-250618-1443") {
        await this.$emit('close');
        await  this.$router.push("/trackView");
