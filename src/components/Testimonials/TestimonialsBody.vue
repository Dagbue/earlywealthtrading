<template>
  <div class="alpha">
    ...
    <p class="section-title">Hear from Our&nbsp;<span style="color: #0bccbf;">Customers</span></p>
    ...
    <p class="section-sub-text-2">
      At EWT, we believe that the heart of our business lies in the satisfaction of our customers. Your feedback is
      invaluable as it not only helps us improve our products and services but also affirms our commitment to
      excellence. Each review and testimonial shared here reflects our ongoing dedication to providing the highest
      quality service and support. Thank you for trusting us to be a part of your journey."
    </p>
...
export default {
  ...
  data() {
    return {
      ...
      videoSrc: require('@/assets/testivideo1.mp4'),
      videoSrc2: require('@/assets/testivideo2.mp4'),
      videoSrc3: require('@/assets/testivideo3.mp4'),
    }
  }
}
</script>
